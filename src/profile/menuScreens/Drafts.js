...
function Drafts({profilePhoto, route}) {
    ...
    <SafeAreaView style={{flex: 1, backgroundColor: '#f5f6fa'}}>
      <ScrollView>
        <Container footer={false}>
            <Header />
            <DraftCard photo={photo ? photo : profilePhoto} available={true} />
            <DraftCard photo={photo ? photo : profilePhoto} available={false} />
            <DraftCard photo={photo ? photo : profilePhoto} available={false} />
        </Container>
      </ScrollView>
    </SafeAreaView>
...
Drafts.defaultProps = {
    profilePhoto: 'https://viajes.nationalgeographic.com.es/medio/2013/09/02/hemis_0314966_1000x766.jpg'
}